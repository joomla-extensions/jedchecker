...
<div id="jedchecker">
	<div class="row g-3">
				...
				<div class="card-header"><?php echo Text::_('COM_JEDCHECKER_RESULTS'); ?></div>
					<div role="tablist" class="list-group list-group-flush">
							...
							foreach ($this->ruleClasses as $i => $fqcn) :
								...
								$rule      = new $fqcn;
								?>
								<a role="tab" id="jed-<?php echo $shortName; ?>" data-bs-toggle="tab" href="#jedtab-<?php echo $shortName; ?>"
		...
		<div class="col-12 col-md-9 jedchecker-results hidden">
			...
			<?php foreach ($this->ruleClasses as $i => $fqcn) :
				$parts     = explode('\\', $fqcn);
				$shortName = strtolower(preg_replace('/Rule$/', '', end($parts)));
				$rule      = new $fqcn;
				?>
				<div role="tabpanel" class="tab-pane fade<?php echo $i === 0 ? ' show active' : ''; ?>" id="jedtab-<?php echo $shortName; ?>">
				<div class="card">
					...
					<div class="card-body">
						...
						<div class="card-text police-check-result" id="police-check-result-<?php echo $shortName; ?>">
