	...
	private function scanFile(string $path): bool
	{
		...
		if (in_array(pathinfo($path, PATHINFO_EXTENSION), $ext) && filesize($path))
		{
			...
			$scopes      = [
				...
				'php'   => CheckerHelper::cleanPhpCode($content, CheckerHelper::CLEAN_COMMENTS | CheckerHelper::CLEAN_HTML),
				'code'  => CheckerHelper::cleanPhpCode($content, CheckerHelper::CLEAN_COMMENTS | CheckerHelper::CLEAN_HTML | CheckerHelper::CLEAN_STRINGS),
			];
